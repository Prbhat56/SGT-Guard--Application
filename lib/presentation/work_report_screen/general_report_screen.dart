...
class GeneralReportScreen extends StatefulWidget {
  ...
  static _GeneralReportScreenState? of(BuildContext context) =>
      context.findAncestorStateOfType<_GeneralReportScreenState>();
...
//pick image from gallery
  ...
  Widget build(BuildContext context) {
    return MediaQuery(
      ...
      child: Scaffold(
        appBar:
         CustomAppBarWidget(appbarTitle: 'general_report'.tr),
