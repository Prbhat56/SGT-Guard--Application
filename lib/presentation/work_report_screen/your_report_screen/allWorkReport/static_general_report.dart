...
class StaticGeneralReportScreen extends StatefulWidget {
  String? propId;
  String? propName;
  StaticGeneralReportScreen(
      {super.key, required this.propId, required this.propName});

  static _StaticGeneralReportScreenState? of(BuildContext context) =>
      context.findAncestorStateOfType<_StaticGeneralReportScreenState>();

  @override
  State<StaticGeneralReportScreen> createState() =>
      _StaticGeneralReportScreenState();
}

class _StaticGeneralReportScreenState extends State<StaticGeneralReportScreen> {
...
//pick image from gallery
  ...
  Future<void> uploadImage() async {
    ...
    String apiUrl = baseUrl + apiRoutes['generalReport']!;
