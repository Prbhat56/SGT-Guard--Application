...
class Checkpoint {
    ...
    factory Checkpoint.fromJson(Map<String, dynamic> json) => Checkpoint(
        ...
        route: json["route"] == null ? null : RouteDetail.fromJson(json["route"]),
        checkPointAvatar: json["check_point_avatar"] == null ? [] : List<CheckPointAvatar>.from(json["check_point_avatar"]!.map((x) => CheckPointAvatar.fromJson(x))),
    );
...
class Shift {
    ...
    DateTime? createdAt;
    DateTime? updatedAt;
    DateTime? clockOutFull;
    String? totalDutyHours;
    int? totalDutyHoursInSecond;
    int? shiftClockInTimeInSecond;
    ...
    Shift({
        ...
        this.clockOutFull,
        this.totalDutyHours,
        this.totalDutyHoursInSecond,
        this.shiftClockInTimeInSecond,
    });
    ...
    factory Shift.fromJson(Map<String, dynamic> json) => Shift(
        ...
        createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
        updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
        clockOutFull: json["clock_out_full"] == null ? null : DateTime.parse(json["clock_out_full"]),
        totalDutyHours: json["total_duty_hours"],
        totalDutyHoursInSecond: json["total_duty_hours_in_second"],
        shiftClockInTimeInSecond: json["shift_clock_in_time_in_second"],
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "created_at": createdAt?.toIso8601String(),
        "updated_at": updatedAt?.toIso8601String(),
        "clock_out_full": clockOutFull?.toIso8601String(),
        "total_duty_hours": totalDutyHours,
        "total_duty_hours_in_second": totalDutyHoursInSecond,
        "shift_clock_in_time_in_second": shiftClockInTimeInSecond,
    };
}
