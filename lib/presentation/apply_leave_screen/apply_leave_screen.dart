...
class _ApplyLeaveScreenState extends State<ApplyLeaveScreen> {
  ...
  DateTime dt2 = DateTime.now(); //DateTime.parse("2018-02-27 10:09:00");
  ...
  Future<void> applyLeavePolicy() async {
    try {
      String apiUrl = baseUrl +
          ...
          '?property_owner_id=${userD['user_details']['property_owner_id']}';
      ...
      if (response.statusCode == 201) {
        ...
        print('Leave Policies ${leaveTerms}');
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Leave From \*',
                          style:
                              CustomTheme.blueTextStyle(17, FontWeight.w500)),
                      SizedBox(height: 10),
                      Container(
